...
class CoinManager: ObservableObject {
    ...
    init() {
        ...
        let iapItem0 = StoreItem.init(id: 0, iapId: "com.CreateIcon.ownmake.listone", coin: 100, price: "$1.99", color: "#FFDCEC")
        let iapItem1 = StoreItem.init(id: 1, iapId: "com.CreateIcon.ownmake.listtwo", coin: 300, price: "$2.99", color: "#C9FFEE")
        let iapItem2 = StoreItem.init(id: 2, iapId: "com.CreateIcon.ownmake.listthree", coin: 500, price: "$4.99", color: "#FFDCEC")
        let iapItem3 = StoreItem.init(id: 3, iapId: "com.CreateIcon.ownmake.listfour", coin: 1000, price: "$6.99", color: "#C9FFEE")
        let iapItem4 = StoreItem.init(id: 4, iapId: "com.CreateIcon.ownmake.listfive", coin: 1500, price: "$9.99", color: "#FFDCEC")
        let iapItem5 = StoreItem.init(id: 5, iapId: "com.CreateIcon.ownmake.listsix", coin: 2000, price: "$12.99", color: "#C9FFEE")
        let iapItem6 = StoreItem.init(id: 6, iapId: "com.CreateIcon.ownmake.listseven", coin: 3000, price: "$15.99", color: "#FFDCEC")
        let iapItem7 = StoreItem.init(id: 7, iapId: "com.CreateIcon.ownmake.listeight", coin: 4000, price: "$19.99", color: "#C9FFEE")
