...
extension APLoginVC {
    func setupView() {
        ...
        let topBgImgV = UIImageView(image: UIImage(named: "log_background"))
        ...
        topInfoLabel.text = "Create Different\nStyles&Trends"
