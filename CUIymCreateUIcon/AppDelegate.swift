...
enum AdjustKey: String {
    case AdjustKeyAppToken = "eobj7p36slq8"
    case AdjustKeyAppLaunch = "w3gnfn"
    case AdjustKeyAppCoinsBuy = "a0u4kq"
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
    var mainVC: CUIymMainVC = CUIymMainVC()
...
//        com.CreateIcon.ownmake
        
//        NotificationCenter.default.post(name: .Pre,
//                                        object: [
//                                            HightLigtingHelper.default.debugBundleIdentifier = "com.CreateIcon.ownmake",
